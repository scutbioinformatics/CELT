function [MA_nmi_value,MA_ACC,MA_AR,MA_f,MA_p,MA_r,MA_Purity,similarityMatirx] = spectral_pairwise(X1,X2,numClust,sigma1,sigma2,lambda,truth,numiter)
% INPUT:
% OUTPUT:
    ...
    while(i<=numiter+1)
        ...
        similarityMatirx=L2 + lambda*L_u1;
